...
def train_autoencoder(_epoch, num_samples_, x_train, x_val, encoder_weights0, encoder_bias0, encoder_weights1, encoder_bias1, encoder_weights2, encoder_bias2, decoder_weights1, decoder_bias1, decoder_weights3, decoder_bias3, gamma0_enc0, beta0_enc0, gamma0_enc1, beta0_enc1, gamma0_dec1, beta0_dec1, learning_rate, num_epochs, m_encoder_weights0, v_encoder_weights0, m_encoder_bias0, v_encoder_bias0, m_encoder_weights1, v_encoder_weights1, m_encoder_bias1, v_encoder_bias1, m_encoder_weights2, v_encoder_weights2, m_encoder_bias2, v_encoder_bias2, m_decoder_weights1, v_decoder_weights1, m_decoder_bias1, v_decoder_bias1, m_decoder_weights3, v_decoder_weights3, m_decoder_bias3, v_decoder_bias3):
    train_losses = []
    val_losses = []
    count = 0
    ...
    for epoch in range(_epoch, num_epochs):
        ...
        for i in range(0, len(x_train), batch_size):
            ...
            encoded = np.round(sigmoid(np.dot(encoder_output0_bn, encoder_weights2) + encoder_bias2))
            ...
            decoded = sigmoid(np.dot(decoder_output1, decoder_weights3) + decoder_bias3)
            ...
            decoder_delta2 = decoder_delta3.dot(decoder_weights3.T) * sigmoid_derivative(decoder_output1)
            # decoder_error1 = decoder_delta2.dot(decoder_weights2.T)
            # decoder_delta1 = decoder_error1 * sigmoid_derivative(decoder_output1)

            encoder_error2 = decoder_delta2.dot(decoder_weights1.T)
            ...
            encoder_error0 = encoder_delta2.dot(encoder_weights2.T)
            ...
            decoder_weights3 += decoder_output1.T.dot(decoder_delta3) * learning_rate
            decoder_bias3 += np.sum(decoder_delta3, axis=0) * learning_rate
            decoder_weights1 += encoded.T.dot(decoder_delta2) * learning_rate
            decoder_bias1 += np.sum(decoder_delta2, axis=0) * learning_rate

            encoder_weights2 += encoder_output0_bn.T.dot(encoder_delta2) * learning_rate
            ...
            encoder_weights2, encoder_bias2, m_encoder_weights2, v_encoder_weights2, m_encoder_bias2, v_encoder_bias2 = adam_optimizer(
                ...
                encoder_output0_bn.T.dot(encoder_delta2),
            ...
            decoder_weights3, decoder_bias3, m_decoder_weights3, v_decoder_weights3, m_decoder_bias3, v_decoder_bias3 = adam_optimizer(
                ...
                decoder_output1.T.dot(decoder_delta3),
        ...
        for i in range(0, len(x_val), batch_size):
            ...
            # decoder_output2 = sigmoid(np.dot(decoder_output1, decoder_weights2) + decoder_bias2)
            #decoder_output2_bn, _, mean_dec_out2, var_dec_out2 = batchnorm(decoder_output2, gamma0_dec2, beta0_dec2)
            decoded_val = sigmoid(np.dot(decoder_output1, decoder_weights3) + decoder_bias3)
        ...
        if (epoch + 1) % 10 == 0:
            ...
            # decoder_output2 = sigmoid(np.dot(decoder_output1, decoder_weights2) + decoder_bias2)
            #decoder_output2_bn, _, mean_dec_out2, var_dec_out2 = batchnorm(decoder_output2, gamma0_dec2, beta0_dec2)
            decoded_ = sigmoid(np.dot(decoder_output1, decoder_weights3) + decoder_bias3)
...
def main():
    ...
    encoder_hidden_size0 = 1000
    encoder_hidden_size1 = 1000
    encoder_hidden_size2 = 6
    decoder_hidden_size1 = 1000
    # decoder_hidden_size2 = 4
    ...
    if os.path.exists('model.pkl'):
        ...
        decoder_weights3 = np.random.randn(decoder_hidden_size1, output_size)
    ...
    # decoder_output2 = sigmoid(np.dot(decoder_output1, decoder_weights2) + decoder_bias2)
    #decoder_output2_bn, _, mean_dec_out2, var_dec_out2 = batchnorm(decoder_output2, gamma0_dec2, beta0_dec2)
    reconstructed_chunk = np.round(sigmoid(np.dot(decoder_output1, decoder_weights3) + decoder_bias3))
